...
export const DELETE = withErrorHandling("/api/companies/[companyId]/approval-rules/[ruleId]", async (request: NextRequest, ctx: RouteContext<'/api/companies/[companyId]/approval-rules/[ruleId]'>) => {
