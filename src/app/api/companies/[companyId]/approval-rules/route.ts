...
export async function GET(request: NextRequest, ctx: RouteContext<'/api/companies/[companyId]/approval-rules'>) {
...
export async function POST(request: NextRequest, ctx: RouteContext<'/api/companies/[companyId]/approval-rules'>) {
  const { companyId } = await ctx.params;
