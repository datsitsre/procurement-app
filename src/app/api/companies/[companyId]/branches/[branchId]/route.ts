...
export const DELETE = withErrorHandling("/api/companies/[companyId]/branches/[branchId]", async (request: NextRequest, ctx: RouteContext<'/api/companies/[companyId]/branches/[branchId]'>) => {
